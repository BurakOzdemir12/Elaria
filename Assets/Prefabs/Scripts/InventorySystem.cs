...
public class InventorySystem : MonoBehaviour
{
    ...
    public List<GameObject> slotList= new List<GameObject>(); //contain main slot without objects

    public List<string>itemList= new List<string>(); //contains actual names items
