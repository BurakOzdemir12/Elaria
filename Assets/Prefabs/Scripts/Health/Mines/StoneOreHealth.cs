...
public class StoneOreHealth : MonoBehaviour
{
    ...
    [SerializeField] private ParticleSystem stoneDamageParticles;
    [SerializeField] private ParticleSystem stoneBreaksParticles;
    ...
    public void takeDamage(int damage, GameObject player, string attackerTag)
    {
        ...
        IEnumerator DamageWithDelay(int damage)
        {
            ...
            if (stoneDamageParticles != null)
            {
                stoneDamageParticles.Play();
            }
        ...
        if (currentHealth <= 0)
        {
            ...
            if (stoneBreaksParticles != null)
            {
                ParticleSystem newParticles = Instantiate(stoneBreaksParticles, transform.position + new Vector3(0, 3, 0), stoneBreaksParticles.transform.rotation);
                newParticles.Play();

                /* Vector3 particlePosition = transform.position + new Vector3(0, 3, 0);
                 ...
                 ParticleSystem newParticles = Instantiate(stoneBreaksParticles, particlePosition, particleRotation);
...
[System.Serializable]
public class StoneItemDrop
{
    public GameObject StoneItemToDrop;
