...
public class MythrilOreHealth : MonoBehaviour
{
    ...
    [SerializeField] private ParticleSystem mythrilDamageParticles;
    [SerializeField] private ParticleSystem mythrilBreaksParticles;
    ...
    public void takeDamage(int damage, GameObject player, string attackerTag)
    {
        ...
        IEnumerator DamageWithDelay(int damage)
        {
            ...
            if (mythrilDamageParticles != null)
            {
                mythrilDamageParticles.Play();
            }
        ...
        if (currentHealth <= 0)
        {
            ...
            if (mythrilBreaksParticles != null)
            {
                ParticleSystem newParticles = Instantiate(mythrilBreaksParticles, transform.position + new Vector3(0, 3, 0), mythrilBreaksParticles.transform.rotation);
                newParticles.Play();
                ...
                ParticleSystem newParticles = Instantiate(mythrilBreaksParticles, particlePosition, particleRotation);
...
[System.Serializable]
public class MythrilOreItemDrop
{
    public GameObject MythrilOreItemToDrop;
