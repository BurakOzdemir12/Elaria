...
public class GoldOreHealth : MonoBehaviour
{
    ...
    [SerializeField] private ParticleSystem goldDamageParticles;
    [SerializeField] private ParticleSystem goldBreaksParticles;
    ...
    public void takeDamage(int damage, GameObject player, string attackerTag)
    {
        ...
        IEnumerator DamageWithDelay(int damage)
        {
            ...
            if (goldDamageParticles != null)
            {
                goldDamageParticles.Play();
            }
        ...
        if (currentHealth <= 0)
        {
            ...
            if (goldBreaksParticles != null)
            {
                ParticleSystem newParticles = Instantiate(goldBreaksParticles, transform.position + new Vector3(0, 3, 0), goldBreaksParticles.transform.rotation);
                newParticles.Play();
                ...
                ParticleSystem newParticles = Instantiate(goldBreaksParticles, particlePosition, particleRotation);
...
[System.Serializable]
public class GoldItemDrop
{
    public GameObject GoldItemToDrop;
